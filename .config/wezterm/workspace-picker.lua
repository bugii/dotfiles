--- WezTerm Workspace Switcher
---
--- A comprehensive workspace switcher for WezTerm that integrates with:
...
--- workspace_picker.apply_to_config(config, "f", "LEADER")
--- ```
---
--- @module workspace-picker
--- @author Dario
--- @license MIT
--- @version 1.0.0
