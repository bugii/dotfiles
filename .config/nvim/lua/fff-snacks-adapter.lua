...
local function on_close() M.state.current_file_cache = nil end
...
function M.fff()
  ...
  if not file_picker.is_initialized() then
    ...
    if not setup_success then vim.notify("Failed to initialize file picker", vim.log.levels.ERROR) end
  end
  Snacks.picker({
    title = "FFFiles",
    finder = finder,
